 ...
 * @precision: precision of the specifier
 * @size: size of the specifier
 * Return: number of the charctors printed.
 */
 ...
 * @flags: the flags
 * @width: the width
 * @prec: precision of the specifier
 * @length: number of the length
 * @padd: Pading charctors
 * @extra_c: Extra charctor
 * Return: number of the printed charctors
 */
 ...
 * Return: number of written charctors
 */
